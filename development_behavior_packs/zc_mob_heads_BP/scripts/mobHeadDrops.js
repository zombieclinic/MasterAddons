...
const NAMED_EASTER_EGG_HEADS = Object.freeze({
  "cult of the dead chicken": "zombie:cultofthedeadchicken_mask",
  "cultofthedeadchicken": "zombie:cultofthedeadchicken_mask",
...
world.afterEvents.entityDie.subscribe((event) => {
  ...
  if (easterEggItem && Math.random() < easterEggChance) {
    try {
      ...
      if (easterEggItem === "zombie:cultofthedeadchicken_mask") {
        itemStack.setLore([
          "§7https://cultofthedeadchicken.com/"
        ]);
      } else if (easterEggItem === "zombie:buzzingsniper38_mask") {
        itemStack.setLore([
      ...
      } else if (easterEggItem === "zombie:vegan_chzburger_mask") {
        itemStack.setLore([
          "§7I know I look good, but",
          "§7control yourself"
        ]);
      } else if (easterEggItem === "zombie:toro_loco_mask") {
        itemStack.setLore([
          "§7The apocalypse?",
          "§7Sign me the hell up!"
        ]);
      } else if (easterEggItem === "zombie:zombieclinic_mask") {
        itemStack.setLore([
          "§7Cult of the Dead Chicken"
        ]);
